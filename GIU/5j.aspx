<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="5j.aspx.cs" Inherits="GIU._5j" %>
                ...
                <div class="form-group">
                 ...
                 <asp:Label runat="server" AssociatedControlID="L_id"><b>lecturer ID: </b></asp:Label><br />
                    ...
                    <asp:TextBox runat="server" required="required" Enabled="true" name="s_id" ID="s_id" class="form-control input-group"></asp:TextBox><br />
                     ...
                     <asp:Label runat="server" AssociatedControlID="DL"><b>Defense Loction : </b></asp:Label><br />
                    <asp:TextBox runat="server" required="required" Enabled="true" name="DL" ID="DL" class="form-control input-group"></asp:TextBox><br />
                    ...
                    &nbsp;<asp:Button ID="okbutton" runat="server" OnClick="LecGradedefense5j" Text="Accept" />
