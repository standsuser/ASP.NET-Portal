<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmpGradeDefense.aspx.cs" Inherits="GIU.EmpGradeDefense" %>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-1">
                <div class="form-group">
                    ...
                    <asp:Label runat="server" AssociatedControlID="e_eid"><b>Enter Empluee ID </b></asp:Label><br />
                    ...
                    &nbsp;<asp:Button ID="okbutton" runat="server" OnClick="Emp_GradeDefense" Text="Accept" />
